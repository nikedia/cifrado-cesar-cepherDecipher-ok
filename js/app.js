...
function cipher (str) {
    ...
    for (var i= 0 ; i<str.length ; i++){
        ...
        if(str.charCodeAt(i)>=65 && str.charCodeAt(i)<=90) //Usamos str.charCodeAt(i) para hallar su equivalente en ASCII
         ...
         }  // Se usa la fórmula brindada por Michelle  que es la sgte: ((x-65+n)%26+65)
...
cipherDecipher('ABC'); //Llamando a la función cipherDecipher para que ejecute las dos funciones.
